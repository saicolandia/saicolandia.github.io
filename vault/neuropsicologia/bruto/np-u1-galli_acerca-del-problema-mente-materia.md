...
```mermaid
flowchart TD
    M1["MUNDO 1<br>Objetos y estados físicos"] --> D1["Materia y energía del cosmos, estructura y acción<br>de los seres humanos, cerebros humanos, sustratos<br>materiales de la actividad humana (artefactos, libros,<br>medicinas sintéticas, computadoras, aviones)"]

    M2["MUNDO 2<br>Estados de consciencia"] --> D2["Conocimiento en sentido subjetivo.<br>Experiencias de percepción, pensamiento,<br>emociones, intenciones, recuerdos, sueños,<br>imágenes creadoras, pensar teorías, formas"]

    M3["MUNDO 3<br>Conocimiento en sentido objetivo"] --> D3["Herencia cultural codificada en sustratos materiales<br>(sistemas teóricos, historias, mitos explicativos,<br>teorías científicas, problemas, lenguaje humano,<br>leyendas)"]
