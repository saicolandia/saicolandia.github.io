...
return [
    ...
    'filename' => '/home/kikodelmar/saicolandia/github/saicolandia.github.io/grav/user/pages/30.sidebars/20.sidebar-right/03._list-none/links.md',
    'modified' => 1786572372,
    'size' => 562,
    'data' => [
        'header' => [
            ...
            'links' => [
                'headline' => 'list-none',
                'byline' => [
                    'text' => 'This paragraph is optional.
'
                ],
                'type' => 'list-none',
                'items' => [
