...
return [
    ...
    'filename' => '/home/kikodelmar/saicolandia/github/saicolandia.github.io/grav/grav-2/user/pages/30.sidebars/10.sidebar-left/03._list-none/links.md',
    'modified' => 1786572372,
    'size' => 598,
    'data' => [
        'header' => [
            ...
            'links' => [
                ...
                'items' => [
                    0 => [
                        ...
                        'description' => 'An item without a link target
'
                    ],
                    1 => [
                        'url' => 'https://en.wikipedia.org/wiki/Romani_ite_domum',
                        'text' => 'Romanes eunt domus',
                        'description' => 'Lorem conque congue vitae ipsum
'
                    ],
                    2 => [
                        'url' => '#',
