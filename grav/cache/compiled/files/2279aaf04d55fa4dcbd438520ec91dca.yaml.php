...
return [
    ...
    'filename' => '/home/kikodelmar/saicolandia/github/saicolandia.github.io/grav/user/plugins/admin/languages/en.yaml',
    'modified' => 1786579405,
    'size' => 66784,
    'data' => [
        'PLUGIN_ADMIN' => [
            ...
            'IMAGES_URL_ACTIONS' => 'Allow URL image actions',
            'IMAGES_URL_ACTIONS_HELP' => 'When enabled, image transforms can be triggered directly from the URL query string (e.g. \'image.jpg?resize=600,400\'). Off by default; normal resizing in your themes and content is unaffected',
            'IMAGES_MAX_PIXELS' => 'Maximum image pixels',
            'IMAGES_MAX_PIXELS_HELP' => 'Total-pixel ceiling (width x height) for URL image actions. Requests above this limit are refused to prevent excessive memory use. Set to 0 to disable the check',
            ...
            'EXTERNAL_URL_HELP' => 'Point this page\'s URL at an external address. When set, the page\'s menu link and `page.url()` resolve to this URL instead of the page\'s own route. e.g. `https://getgrav.org`',
...
You have **2FA** enabled on this account. Please use your **2FA** app to enter the current **6-digit code** to complete the login process.',
            ...
            'CONTENT_SECURITY_HELP' => 'Security checks applied to editor-authored page content.',
            'CONTENT_XSS_SCAN_OUTPUT' => 'Scan content for XSS',
            'CONTENT_XSS_SCAN_OUTPUT_HELP' => 'Re-scan editor-authored content for XSS payloads assembled at render time, before the theme template wraps it. Trusted theme/plugin markup (embeds, form scripts, JS/CSS) is never scanned. Recommended on.',
            'ACCOUNTS' => 'Accounts',
