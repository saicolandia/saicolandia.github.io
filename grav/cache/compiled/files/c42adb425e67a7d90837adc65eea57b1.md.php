...
return [
    ...
    'filename' => '/home/kikodelmar/saicolandia/github/saicolandia.github.io/grav/user/pages/30.sidebars/20.sidebar-right/02._list-decimal/links.md',
    'modified' => 1786572372,
    'size' => 532,
    'data' => [
        'header' => [
            ...
            'links' => [
                'headline' => 'Footnotes',
                'byline' => [
                    'text' => 'Sources used in this article:
'
                ],
                'type' => 'list-decimal',
                'items' => [
