...
return [
    ...
    'checksum' => 'bbd0cf7c0cf2522aedae0e2f56432583',
    'files' => [
...
',
            ...
            'plugins.blackhole.enabled' => [
                ...
                'name' => 'plugins.blackhole.enabled',
                'validation' => 'strict'
            ],
            ...
            'plugins.blackhole.generate.use_sitemap' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.blackhole.generate.use_sitemap',
                'validation' => 'strict'
            ],
...
',
                ...
                'name' => 'themes.oxygen.index',
                'validation' => 'strict'
            ],
            'themes.oxygen.sitetitle' => [
                'type' => 'toggle',
...
',
                ...
                'name' => 'themes.oxygen.sitetitle',
                'validation' => 'strict'
            ],
            'themes.oxygen.sitetitleseparator' => [
                'type' => 'text',
                'size' => 'small',
...
',
                'default' => '-',
                'name' => 'themes.oxygen.sitetitleseparator',
                'validation' => 'strict'
            ],
            'themes.oxygen.dropdown' => [
                'type' => 'toggle',
...
',
                ...
                'name' => 'themes.oxygen.dropdown',
                'validation' => 'strict'
            ],
            'themes.oxygen.jquery' => [
                'type' => 'toggle',
                'label' => 'Load jQuery',
...
',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'blackhole' => [
                    ...
                    'generate' => [
                        ...
                        'use_sitemap' => 'plugins.blackhole.generate.use_sitemap',
            ...
            'themes' => [
                'oxygen' => [
                    'spacer' => 'themes.oxygen.spacer',
                    'index' => 'themes.oxygen.index',
                    'sitetitle' => 'themes.oxygen.sitetitle',
                    'sitetitleseparator' => 'themes.oxygen.sitetitleseparator',
                    'dropdown' => 'themes.oxygen.dropdown',
                    'jquery' => 'themes.oxygen.jquery'
                ]
            ]
        ],
        'dynamic' => [
